...
const WEBPILOT_URL = "https://webpilot.cearapilots.com.br/WebPilot/integracao/lanchas/itHorimetros.aspx?chaveAPI=0d915fbe-f9d4-4d73-8e69-e088973a4541";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Array vazio é resposta válida ("nada a atualizar"): não é erro.
    if (!Array.isArray(lanchasWebPilot))
